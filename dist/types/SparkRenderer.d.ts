...
import { SplatScreenFloodMaskRenderOptions, SplatScreenFloodMaskResult, SplatScreenPickHit, SplatScreenPickIndexOptions, SplatScreenPickNearestCenterOptions, SplatScreenPickNearestCenterResult, SplatScreenPickOptions, SplatScreenPickRenderedIndexOptions, SplatScreenPickRenderedIndexResult, SplatScreenPickStateSelectionOptions, SplatScreenPickStateSelectionResult } from './SplatScreenPicker';
...
export declare class SparkRenderer extends THREE.Mesh {
    ...
    ordering32: Uint32Array<ArrayBuffer>;
    ...
    selectSplatStateFromScreenPick(options: SplatScreenPickStateSelectionOptions): Promise<SplatScreenPickStateSelectionResult | null>;
    private selectSplatStateFromScreenPickCpuProducer;
    pickRenderedSplatIndex(options: SplatScreenPickRenderedIndexOptions): Promise<SplatScreenPickRenderedIndexResult | null>;
